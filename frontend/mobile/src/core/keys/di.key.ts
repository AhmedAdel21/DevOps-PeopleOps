export const DiKeys = {
  ...
  ADMIN_GET_PERMISSION_REQUESTS_USE_CASE: 'adminGetPermissionRequestsUseCase',
  APPROVE_PERMISSION_REQUEST_USE_CASE: 'approvePermissionRequestUseCase',
  REJECT_PERMISSION_REQUEST_USE_CASE: 'rejectPermissionRequestUseCase',
