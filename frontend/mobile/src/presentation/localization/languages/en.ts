export const en = {
  ...
  team: {
    ...
    empty: {
      ...
      subtitle: 'Try adjusting your filters or date selection',
      clear: 'Clear filters',
    },
    error: {
      load: "Couldn't load team attendance",
      retry: 'Retry',
    },
    approvals: {
      ...
      empty: {
        ...
        note: 'Your team requests are all handled',
      },
    },
    detail: {
      ...
      confirm: 'Confirm approval of {{duration}} {{type}}?',
