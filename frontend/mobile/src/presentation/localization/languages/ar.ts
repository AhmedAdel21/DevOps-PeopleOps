export const ar = {
  ...
  auth: {
    ...
    setPassword: {
      ...
      errors: {
        ...
        weakPassword:
          'كلمة المرور ضعيفة. استخدم مزيجًا أقوى من الأحرف والأرقام والرموز.',
        requiresRecentLogin:
          'لمصلحتك الأمنية، يُرجى تسجيل الدخول مرة أخرى قبل تغيير كلمة المرور.',
        noCurrentUser:
          'انتهت جلستك. سجّل الدخول مرة أخرى وحاول مجددًا.',
        changeFailed:
          'تعذّر تحديث كلمة المرور. تحقق من الاتصال وحاول مرة أخرى.',
        resetNotImplemented:
          'إعادة تعيين كلمة المرور غير متاحة بعد. يُرجى استخدام تسجيل الدخول أو التواصل مع الموارد البشرية.',
      },
    },
  ...
  home: {
    ...
    errors: {
      ...
      locationPermissionDenied:
        'يلزم إذن الوصول إلى الموقع لتسجيل الدخول أو الخروج. فعّله من الإعدادات وحاول مرة أخرى.',
      locationUnavailable:
        'تعذر قراءة موقعك. تأكد من تفعيل خدمات الموقع وحاول مجدداً.',
    },
    slackBanner: {
  ...
  team: {
    ...
    empty: {
      ...
      subtitle: 'جرّب تعديل عوامل التصفية أو التاريخ',
      clear: 'مسح عوامل التصفية',
    },
    error: {
      load: 'تعذّر تحميل حضور الفريق',
      retry: 'إعادة المحاولة',
    },
    approvals: {
      ...
      empty: {
        ...
        subtitle: 'لا توجد موافقات معلّقة حاليًا',
        note: 'طلبات فريقك كلها تمت معالجتها',
      },
    },
    detail: {
      header: 'تفاصيل الطلب',
      ...
      confirm: 'تأكيد الموافقة على {{duration}} {{type}}؟',
